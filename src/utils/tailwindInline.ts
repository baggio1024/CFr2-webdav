...
@layer utilities {
  ...
  .shadow-\\[inset_0_2px_4px_rgba\\(0\\,0\\,0\\,0\\.06\\)\\] {
    --tw-shadow: inset 0 2px 4px var(--tw-shadow-color, rgba(0,0,0,0.06));
    box-shadow: var(--tw-inset-shadow), var(--tw-inset-ring-shadow), var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow);
  }
  .shadow-lg {
  ...
  .dark\\:fill-blue-900\\/30 {
    @media (prefers-color-scheme: dark) {
      fill: color-mix(in srgb, oklch(37.9% 0.146 265.522) 30%, transparent);
      @supports (color: color-mix(in lab, red, red)) {
        fill: color-mix(in oklab, var(--color-blue-900) 30%, transparent);
      }
    }
  }
  .dark\\:text-blue-300 {
  ...
  .dark\\:shadow-\\[inset_0_2px_4px_rgba\\(0\\,0\\,0\\,0\\.2\\)\\] {
    @media (prefers-color-scheme: dark) {
      --tw-shadow: inset 0 2px 4px var(--tw-shadow-color, rgba(0,0,0,0.2));
      box-shadow: var(--tw-inset-shadow), var(--tw-inset-ring-shadow), var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow);
    }
  }
  .dark\\:shadow-lg {
